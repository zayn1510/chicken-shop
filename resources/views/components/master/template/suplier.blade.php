...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <p class="poppins font-13 bold">Data Suplier</p>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h5 class="font-13 bold">Data Suplier</h5>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="table-fakultas" style="font-family:font1;font-size:13px">
                                    <div class="data-kategori">
                                        <x-master.table.supliertable />
                                    </div>
                                </div>
                                <x-master.form.suplierform />
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
...
<script type="module" src="{{ asset('dist/js/admin/suplier/app.js') }}"></script>
</body>

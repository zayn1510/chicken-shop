                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 pull-right">
                                        ...
                                        data-toggle="modal" data-target="#bankModal">Tambah
                                        Data</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="table-fakultas" style="font-family:font1;font-size:13px">
                                    <div class="data-kategori">
                                        <x-master.table.bank_table />
                                        <x-master.modal.bank_modal />
                                    </div>
                                </div>
...
<script type="module" src="{{ asset('dist/js/admin/bank/app.js') }}"></script>
</body>
